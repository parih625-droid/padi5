...
router.get('/users', auth.authenticateToken, auth.authorizeAdmin, async (req, res) => {
  try {
...
router.delete('/users/:id', auth.authenticateToken, auth.authorizeAdmin, async (req, res) => {
  try {
    const { id } = req.params;
